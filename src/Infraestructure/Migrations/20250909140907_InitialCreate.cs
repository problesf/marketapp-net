        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    order_customer_id = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    address_id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    address_customer_id = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    address_customer_id1 = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    customer_full_name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    customer_default_billing_address_id = table.Column<long>(type: "bigint", nullable: false),
                    customer_default_shipping_address_id = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_customers", x => x.customer_id);
                    table.ForeignKey(
                        name: "FK_customers_addresses_customer_default_billing_address_id",
                        column: x => x.customer_default_billing_address_id,
                        principalTable: "addresses",
                        principalColumn: "address_id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_customers_addresses_customer_default_shipping_address_id",
                        column: x => x.customer_default_shipping_address_id,
                        principalTable: "addresses",
                        principalColumn: "address_id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    review_customer_id = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_reviews_customers_review_customer_id",
                        column: x => x.review_customer_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_addresses_address_customer_id1",
                table: "addresses",
                column: "address_customer_id1");

            migrationBuilder.CreateIndex(
                name: "ix_addresses_customerid",
                table: "addresses",
                column: "address_customer_id");

            migrationBuilder.CreateIndex(
                name: "ix_addresses_default_billing",
                table: "addresses",
                columns: new[] { "address_customer_id", "address_is_default_billing" });

            migrationBuilder.CreateIndex(
                name: "ix_addresses_default_shipping",
                table: "addresses",
                columns: new[] { "address_customer_id", "address_is_default_shipping" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_customers_customer_default_billing_address_id",
                table: "customers",
                column: "customer_default_billing_address_id");

            migrationBuilder.CreateIndex(
                name: "IX_customers_customer_default_shipping_address_id",
                table: "customers",
                column: "customer_default_shipping_address_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_reviews_review_customer_id",
                table: "reviews",
                column: "review_customer_id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_addresses_customers_address_customer_id",
                table: "addresses",
                column: "address_customer_id",
                principalTable: "customers",
                principalColumn: "customer_id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_addresses_customers_address_customer_id1",
                table: "addresses",
                column: "address_customer_id1",
                principalTable: "customers",
                principalColumn: "customer_id",
